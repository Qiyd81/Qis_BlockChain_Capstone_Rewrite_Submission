...
contract('Verifier', accounts => {
    ...
    it('should verify true with the correct proof', async() => {
        let success = false;
        try { 
            await contractInstance.verifyTx(
            proofData.proof.A,
            proofData.proof.A_p,
            proofData.proof.B,
            proofData.proof.B_p,
        ...
        assert.equal(success, true, 'proof should be verified true')
    });

    // Test verification with incorrect proof
    it('should verify false with the incorrect proof', async() => {
        let success = true;
        try { 
            await contractInstance.verifyTx(
            proofData.proof.A,
        ...
        assert.equal(success, true, 'proof should be verified false')
    });
})
