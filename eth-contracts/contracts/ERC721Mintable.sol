...
contract ERC721 is Pausable, ERC165 {
    ...
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != tokenOwner, "TokenId Owner is not allowed as to address");
        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(msg.sender == tokenOwner || isApprovedForAll(tokenOwner, msg.sender), "Sender need to be the owner of contract or isApprovedForAll");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        // TODO: require from address is the owner of the given token, this is not correct requirement|| from == _tokenApprovals[tokenId]
        require(from == ownerOf(tokenId) , "You need to be the owner to do this");
